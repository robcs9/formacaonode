...
app.get('/recomm', (req, res) => {
    res.send("Maybe, check out my bare-bone <a href='https://robcs9.github.io'>blog</a> in the meantime? Yes, it\'s got a long way to go before becoming a proper blog and I have not really updated it at all, but we all got to start somewhere, right? <br><br><em>One step at a time.</em>")
    res.end()
})
